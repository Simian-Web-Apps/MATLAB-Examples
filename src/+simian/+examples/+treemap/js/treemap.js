function fillTreemap(data, year) {
    ...
    console.log("Min: " + Math.min(...lifeExp));
    console.log("Mean: " + lifeExp.reduce((a, b) => a + b, 0) / lifeExp.length);
    console.log("Max: " + Math.max(...lifeExp));
    console.log("Cmid: " + lifeExp.slice(-1));
